        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div className="bg-blue-600 rounded-2xl shadow-lg overflow-hidden">
              <div className="p-8 relative">
                ...
                <div className="flex items-center gap-6">
                  <div className="w-24 h-24 bg-gradient-to-br from-pink-400 to-blue-400 rounded-full flex items-center justify-center border-4 border-white shadow-lg">
                    <User className="w-12 h-12 text-white" />
                  </div>
                  <div className="text-white">
                    <h2 className="text-3xl font-bold">Ahmad Rizki</h2>
                    <p className="text-blue-100 text-lg mt-1">Mahasiswa Aktif</p>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-white p-8">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                  {/* Informasi Pribadi */}
                  <div>
                    <h3 className="text-xl font-bold text-gray-900 mb-4">Informasi Pribadi</h3>
                    ...
                    <div className="space-y-4">
                      <div className="flex items-start gap-3">
                        ...
                        <div>
                          ...
                          <p className="text-gray-900 font-medium">Laki-laki</p>
                        </div>
                      </div>
                      ...
                      <div className="flex items-start gap-3">
                        ...
                        <div>
                          ...
                          <p className="text-gray-900 font-medium">Surabaya, Jawa Timur</p>
                        </div>
                      </div>
                      ...
                      <div className="flex items-start gap-3">
                        ...
                        <div>
                          ...
                          <p className="text-gray-900 font-medium break-all">ahmad.rizki@student.univ.ac.id</p>
                        </div>
                      </div>
                    </div>
                  </div>
                  ...
                  {/* Badge & Pencapaian */}
                  <div>
                    <h3 className="text-xl font-bold text-gray-900 mb-4">Badge & Pencapaian</h3>
                    ...
                    <div className="grid grid-cols-2 gap-3">
                      <div className="bg-yellow-50 border-2 border-yellow-200 rounded-xl p-4 text-center">
                        ...
                        <p className="font-semibold text-yellow-900 text-sm">Konsisten</p>
                        <p className="text-xs text-yellow-700 mt-1">Catat harian 30 hari</p>
                      </div>
                      ...
                      <div className="bg-green-50 border-2 border-green-200 rounded-xl p-4 text-center">
                        ...
                        <p className="font-semibold text-green-900 text-sm">Konsisten</p>
                        <p className="text-xs text-green-700 mt-1">Catat harian 60 hari</p>
                      </div>
                      ...
                      <div className="bg-blue-50 border-2 border-blue-200 rounded-xl p-4 text-center">
                        ...
                        <p className="font-semibold text-blue-900 text-sm">Konsisten</p>
                        <p className="text-xs text-blue-700 mt-1">Catat harian 90 hari</p>
                      </div>
                      ...
                      <div className="bg-purple-50 border-2 border-purple-200 rounded-xl p-4 text-center">
                        ...
                        <p className="font-semibold text-purple-900 text-sm">Konsisten</p>
                        <p className="text-xs text-purple-700 mt-1">Catat harian 120 hari</p>
                      </div>
                    </div>
                  </div>
                </div>
          ...
          <div className="lg:col-span-1">
            <div className="bg-white rounded-2xl shadow-lg p-6">
              <h3 className="text-xl font-bold text-gray-900 mb-6">Saldo Saat Ini</h3>
              ...
              <div className="text-center mb-6">
                <p className="text-4xl font-bold text-gray-900">Rp 2.850.000</p>
              </div>
              
              <div className="space-y-3 pt-4 border-t border-gray-200">
                <div className="flex justify-between items-center">
                  <span className="text-gray-600">Pemasukan</span>
                  <span className="text-green-600 font-semibold">Rp 3.200.000</span>
                </div>
                <div className="flex justify-between items-center">
                  <span className="text-gray-600">Pengeluaran</span>
                  <span className="text-red-600 font-semibold">Rp 350.000</span>
                </div>
              </div>
            </div>
          </div>
...
// Komponen Edit Profile Page
const EditProfilePage = ({ onBack }) => {
  const [formData, setFormData] = useState({
    username: 'Ahmad Rizki Pratama',
    statusMahasiswa: 'Aktif',
    jenisKelamin: 'Laki-laki',
    domisili: 'Jl. Merdeka No. 123, Kelurahan Sukamaju, Kecamatan Bandung Tengah, Kota Bandung, Jawa Barat 40114',
    noTelepon: '81234567890',
